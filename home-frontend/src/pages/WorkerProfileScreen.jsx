...
export default function WorkerProfileScreen() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 page-enter">
            {/* Header rojo */}
            <div className="bg-brand px-5 pt-14 pb-16">
                <IconButton
                    icon={ArrowLeft}
                    variant="ghost"
                    aria-label="Volver"
                    className="mb-4 !rounded-xl !bg-white/20 !text-white"
                    onClick={() => navigate(-1)}
                />
            ...
            <div className="px-5 -mt-8">
                ...
                <div className="bg-white rounded-2xl shadow-card p-5 mb-4">
                    <h3 className="font-bold text-[15px] text-ink mb-4">Calificaciones</h3>
                ...
                {/* Reseñas */}
                <h3 className="font-bold text-[15px] text-ink mb-3">Reseñas</h3>
                        ...
                        <div key={r.id} className="bg-white rounded-2xl p-4 shadow-sm">
                            <div className="flex items-start justify-between mb-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p className="font-semibold text-[13px] text-ink">{r.reviewer?.name}</p>
